...
LIBCAIRO_CFLAGS:=                                                   \
    -DPACKAGE_VERSION="\"cairo-1.12.16\""                           \
    -DPACKAGE_BUGREPORT="\"sean.seefried@gmail.com\"" \
    -DCAIRO_NO_MUTEX=1                                              \
    -DHAVE_STDINT_H                                                 \
    -DHAVE_UINT64_T                                                 \
...
LOCAL_CFLAGS    := -O2 $(LIBCAIRO_CFLAGS) -I$(LOCAL_PATH)/../pixman-0.32.6/pixman -Isrc -Wno-missing-field-initializers -Wno-attributes
# LOCAL_LDFLAGS   := -lz
